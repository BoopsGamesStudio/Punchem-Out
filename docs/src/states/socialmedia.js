...
PunchemOut.socialmediaState.prototype = {
    ...
    create: function () {
        ...
        twitter = this.add.button(game.world.width * 0.25, game.world.centerY, 'twitterLogo', function () { window.location.href = "https://twitter.com/Boops_Games"; });
        ...
        youtube = this.add.button(game.world.width * 0.75, game.world.centerY, 'youtubeLogo', function () { window.location.href = "https://www.youtube.com/channel/UCdlggk1-f6dqdhcsiB29jWA"; });
