...
PunchemOut.leaderboardState.prototype = {
    ...
    create: function () {
        ...
        leaderBoard = game.add.text(game.world.centerX, game.world.height * 0.1, "Top Scores:\n");
        switch (level) {
            case 1:
        ...
        back = this.add.button(game.world.width * 0.13, game.world.height * 0.87, 'botones', function () { game.state.start('levelState'); }, this, 9, 8);
