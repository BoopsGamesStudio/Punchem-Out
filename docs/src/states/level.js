...
PunchemOut.levelState.prototype = {
    ...
    create: function () {
        ...
        lvl1 = this.add.button(game.world.width * 0.25, game.world.height * 0.5, 'botones2', function () { startState(1, 'gameState'); }, this, 3, 2);
        lvl1.scale.setTo(game.world.height / 800);
        lvl1.anchor.setTo(0.5);

        lvl2 = this.add.button(game.world.centerX, game.world.height * 0.5, 'botones2', function () { startState(2, 'gameState'); }, this, 5, 4);
        lvl2.scale.setTo(game.world.height / 800);
        lvl2.anchor.setTo(0.5);

        lvl3 = this.add.button(game.world.width * 0.75, game.world.height * 0.5, 'botones2', function () { startState(3, 'gameState'); }, this, 7, 6);
